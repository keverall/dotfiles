...
[[ -d ~/repos ]] || mkdir -p ~/repos; cd ~/repos
...
# 1. TELL OH MY ZSH TO IGNORE LOCAL THEME DIRECTORIES
ZSH_THEME=""

# 2. KEEP ALL OF YOUR CUSTOM LAYOUT CONFIGURATIONS INTACT
...
alias ff='fastfetch --logo-type sixel --logo ~/Downloads/CachyOS-nice.jpg --logo-width 30'
...
export PATH="$JAVA_HOME/bin:/usr/share/java/:$PATH"
...
# Source native system plugins
source /usr/share/zsh/plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
source /usr/share/zsh/plugins/zsh-autosuggestions/zsh-autosuggestions.zsh

# Source native system Powerlevel10k theme framework
